	...
	<div class="form-style-5">
		<form method="post" action="calendarmodifyresult.do">
			<fieldset>
				...
				<input type="text" id="no" name="no" value="<%=dto.getCalendar_no() %>" readonly="readonly">
				 <input
					type="text" id="title" name="title"
					value="<%=dto.getCalendar_title()%>">
					<textarea id="calcontent" name="content"
					><%=dto.getCalendar_content()%></textarea>
					<input type="text" id="place" name="place" value="<%=dto.getCalendar_place()%>">
					<select id="color"name='color' value='<%=dto.getCalendar_color()%>'>					
					...
					<input type="date"id="start" name="start" value="<%=dto.getCalendar_start()%>">
				<input type="date" id="end" name="end"
					value="<%=dto.getCalendar_end()%>">  <input type="text"
					id="place" name="place" value="<%=dto.getCalendar_place()%>">
				 <input type="submit"
